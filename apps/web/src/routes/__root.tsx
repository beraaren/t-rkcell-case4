  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-muted-foreground">Bu sayfa bulunamadı.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "EduCell — Çevrimiçi Eğitim Platformu" },
      { name: "description", content: "Turkcell EduCell — kurslar, sınavlar ve dijital sertifikalar." },
    ],
